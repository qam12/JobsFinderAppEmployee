...
public class Rate_Employers_List_Fragment extends Fragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.rate_employers_list, null);



        ListView lv = (ListView) v.findViewById(R.id.rate_employers_listView);
        ...
        CustomAdapterRateEmployers adapter = new CustomAdapterRateEmployers(getContext(), R.layout.job_offers_list_items, list, getActivity());
